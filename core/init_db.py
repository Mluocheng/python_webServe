...
from models.database import Base, User, Role, Resource, UserRole, RoleResource
...
engine = create_engine(
    url="mysql+mysqldb://root:ytd58258@localhost:3306/demo?charset=utf8mb4", # settings.DATABASE_URI,  # 数据库uri
    echo=False, # settings.DATABASE_ECHO,  # 是否打印日志
